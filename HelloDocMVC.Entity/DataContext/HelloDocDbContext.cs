...
namespace HelloDocMVC.Entity.DataContext;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BlockRequest>(entity =>
        {
            ...
            entity.Property(e => e.BlockRequestId).HasIdentityOptions(null, null, null, 123456L, true, null);
        ...
        modelBuilder.Entity<CaseTag>(entity =>
        {
            ...
            entity.Property(e => e.CaseTagId).HasIdentityOptions(null, null, null, 123456L, true, null);
        });
        ...
        modelBuilder.Entity<Concierge>(entity =>
        {
            ...
            entity.Property(e => e.ConciergeId).HasIdentityOptions(null, null, null, 123456L, true, null);
        ...
        modelBuilder.Entity<Request>(entity =>
        {
            ...
            entity.Property(e => e.RequestId).HasIdentityOptions(null, null, null, 1234565L, true, null);

            entity.HasOne(d => d.Physician).WithMany(p => p.Requests).HasConstraintName("Physician");

            entity.HasOne(d => d.User).WithMany(p => p.Requests).HasConstraintName("User");
        });
        ...
        modelBuilder.Entity<RequestClient>(entity =>
        {
            ...
            entity.HasOne(d => d.Region).WithMany(p => p.RequestClients).HasConstraintName("Region");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasOne(d => d.AspNetUser).WithMany(p => p.Users).HasConstraintName("User");
